...
window.addEventListener('load', async () => {
  ...
  if (accessToken) {
    ...
    // Llamar automáticamente a la función para mostrar los datos
...
// Función para redirigir a la autenticación OAuth si no hay un token
...
// Asociar evento al botón solo en caso de que el usuario quiera actualizar los datos manualmente
